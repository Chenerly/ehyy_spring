...
public class PoiExcelToHtmlUtil {
     ...
     */
    public static String excelWriteToHtml(Workbook wb){

        String excelHtml = PoiExcelToHtmlUtil.readExcelToHtml(wb, true);
        return excelHtml;
    }
    /**
     * 程序入口方法（将excel文件流读取成字符串）
     * @param isWithStyle 是否需要表格样式 包含 字体 颜色 边框 对齐方式
     * @return <table>...</table> 字符串
     */
    public static String readExcelToHtml(Workbook wb , boolean isWithStyle){
    ...
    private static String getCellValue(Cell cell) {
        ...
        switch (cell.getCellType()) {
            ...
            case Cell.CELL_TYPE_FORMULA:// 公式
                ...
                result = String.valueOf(cellData);
                break;
